...
export default function MeetingDetailsCard({name, email, phoneNo, time, message, Additional_info = {}, MeetingType }) {
  return (
    <>
   
  <div className="mt-2.5 w-full bg-white p-4 rounded shadow-sm max-w-3xl mx-auto my-auto">
    <div className="mb-4">
    ...
    <div className="text-sm text-gray-700 dark:text-gray-200 border-t pt-4 mb-2.5">
    ...
    <button className='py-1 px-2.5 rounded-full bg-green-300 border border-green-400'>Mark as Completed</button>
  </div>
